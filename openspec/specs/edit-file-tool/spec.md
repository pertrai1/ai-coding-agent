...
The `edit_file` tool provides a mechanism for making targeted, find-and-replace style edits to existing files. It requires the caller to provide the exact text to find, making it precise and safer than line-based editing approaches.
