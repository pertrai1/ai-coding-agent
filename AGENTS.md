...
This is a TypeScript Node.js CLI project building an AI coding agent (similar to Claude Code, Codex, AmpCode). The project is built one phase at a time following `ROADMAP.md`, which translates `REQUIREMENTS.md` into atomic tasks.
...
For every project phase, write a detailed `FOR-Rob-Simpson.md` file that explains the whole project in plain language.
